    ...
    if (Object.keys(err).length === 0) {
      ...
      if (response) {
        Swal.fire(
          ...
          'Su pago ha sido procesado, espere a que sea verificado, luego de ello recibirá un correo con sus números en su bandeja de spam, tenga paciencia, NO SE REGISTRE MAS DE UNA VEZ O DEBERÁ CANCELAR TODAS LAS COMPRAS GENERADAS, Número de soporte via whatsapp OJO NO LLAMADAS +584241326694',
          'success',
        );
        setName('');
        setIdPago('');
